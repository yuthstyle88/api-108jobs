...
CREATE INDEX idx_post_aggregates_featured_category_newest_comment_time ON public.post_aggregates USING btree (featured_category DESC, newest_comment_time DESC);
...
CREATE INDEX idx_post_aggregates_featured_category_comments ON public.post_aggregates USING btree (featured_category DESC, comments DESC);
...
CREATE INDEX idx_post_aggregates_featured_category_hot ON public.post_aggregates USING btree (featured_category DESC, hot_rank ((score)::numeric, published) DESC, published DESC);
...
CREATE INDEX idx_post_aggregates_featured_category_score ON public.post_aggregates USING btree (featured_category DESC, score DESC);
...
CREATE INDEX idx_post_aggregates_featured_category_published ON public.post_aggregates USING btree (featured_category DESC, published DESC);
...
CREATE INDEX idx_post_aggregates_featured_category_active ON public.post_aggregates USING btree (featured_category DESC, hot_rank ((score)::numeric, newest_comment_time_necro) DESC, newest_comment_time_necro DESC);
...
CREATE INDEX idx_category_aggregates_hot ON public.category_aggregates USING btree (hot_rank ((subscribers)::numeric, published) DESC, published DESC);
