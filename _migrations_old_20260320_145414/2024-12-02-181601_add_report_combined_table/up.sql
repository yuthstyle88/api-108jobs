...
(
    ...
    CHECK (num_nonnulls(post_report_id, comment_report_id) = 1)
);
...
INSERT INTO report_combined (published, post_report_id, comment_report_id)
SELECT published,
       id,
       NULL::int
FROM post_report
...
ALTER
CONSTRAINT report_combined_post_report_id_fkey NOT DEFERRABLE,
    ALTER
CONSTRAINT report_combined_comment_report_id_fkey NOT DEFERRABLE;