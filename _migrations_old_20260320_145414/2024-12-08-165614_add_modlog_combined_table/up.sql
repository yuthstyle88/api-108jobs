...
ALTER TABLE admin_purge_category RENAME COLUMN when_ TO published;
...
ALTER TABLE mod_add_category RENAME COLUMN when_ TO published;

ALTER TABLE mod_ban RENAME COLUMN when_ TO published;

ALTER TABLE mod_ban_from_category RENAME COLUMN when_ TO published;

ALTER TABLE mod_feature_post RENAME COLUMN when_ TO published;

ALTER TABLE mod_hide_category RENAME COLUMN when_ TO published;
...
ALTER TABLE mod_remove_category RENAME COLUMN when_ TO published;

ALTER TABLE mod_remove_post RENAME COLUMN when_ TO published;

ALTER TABLE mod_transfer_category RENAME COLUMN when_ TO published;
...
CREATE TABLE modlog_combined (
    ...
    admin_purge_category_id int UNIQUE REFERENCES admin_purge_category ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    ...
    mod_add_category_id int UNIQUE REFERENCES mod_add_category ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    mod_ban_id int UNIQUE REFERENCES mod_ban ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    mod_ban_from_category_id int UNIQUE REFERENCES mod_ban_from_category ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    mod_feature_post_id int UNIQUE REFERENCES mod_feature_post ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    mod_hide_category_id int UNIQUE REFERENCES mod_hide_category ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    ...
    mod_remove_category_id int UNIQUE REFERENCES mod_remove_category ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    mod_remove_post_id int UNIQUE REFERENCES mod_remove_post ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE,
    mod_transfer_category_id int UNIQUE REFERENCES mod_transfer_category ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE
);
...
INSERT INTO modlog_combined (published, admin_purge_category_id)
SELECT
    published,
    id
FROM
...
INSERT INTO modlog_combined (published, mod_add_category_id)
SELECT
    published,
    id
FROM
...
INSERT INTO modlog_combined (published, mod_ban_from_category_id)
SELECT
    published,
    id
FROM
...
INSERT INTO modlog_combined (published, mod_hide_category_id)
SELECT
    published,
    id
FROM
...
INSERT INTO modlog_combined (published, mod_remove_category_id)
SELECT
    published,
    id
FROM
...
INSERT INTO modlog_combined (published, mod_transfer_category_id)
SELECT
    published,
    id
FROM
...
ALTER TABLE modlog_combined
    ...
    ALTER CONSTRAINT modlog_combined_admin_purge_category_id_fkey NOT DEFERRABLE,
    ...
    ALTER CONSTRAINT modlog_combined_mod_add_category_id_fkey NOT DEFERRABLE,
    ALTER CONSTRAINT modlog_combined_mod_ban_id_fkey NOT DEFERRABLE,
    ALTER CONSTRAINT modlog_combined_mod_ban_from_category_id_fkey NOT DEFERRABLE,
    ALTER CONSTRAINT modlog_combined_mod_feature_post_id_fkey NOT DEFERRABLE,
    ALTER CONSTRAINT modlog_combined_mod_hide_category_id_fkey NOT DEFERRABLE,
    ...
    ALTER CONSTRAINT modlog_combined_mod_remove_category_id_fkey NOT DEFERRABLE,
    ALTER CONSTRAINT modlog_combined_mod_remove_post_id_fkey NOT DEFERRABLE,
    ALTER CONSTRAINT modlog_combined_mod_transfer_category_id_fkey NOT DEFERRABLE;
