...
pub use app_108jobs_db_views_site::api::{
  DeleteAccount, ListPersonHidden, ListPersonHiddenResponse, ListPersonRead,
  ListPersonReadResponse, MyUserInfo, SaveUserSettings,
};
...
pub mod auth {
  ...
  pub use app_108jobs_db_views_site::api::{
    CaptchaResponse, ChangePassword, GenerateTotpSecretResponse, GetCaptchaResponse,
    ListLoginsResponse, Login, LoginResponse, PasswordChangeAfterReset, PasswordReset,
