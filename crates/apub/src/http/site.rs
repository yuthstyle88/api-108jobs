...
pub(crate) async fn get_apub_site_http(context: Data<FastJobContext>) -> FastJobResult<HttpResponse> {
...
pub(crate) async fn get_apub_site_outbox(context: Data<FastJobContext>) -> FastJobResult<HttpResponse> {
