...
pub enum FastJobErrorType {
  ...
  Locked,
  CouldntCreateProposal,
  MaxProposalDepthReached,
  NoProposalEditAllowed,
  ...
  CouldntUpdateReadProposals,
  CouldntHidePost,
  CouldntUpdateCategory,
  CouldntCreatePersonProposalMention,
  CouldntUpdatePersonProposalMention,
  ...
  PluginError(String),
  InvalidFetchLimit,
  CouldntCreateProposalReply,
  CouldntUpdateProposalReply,
  CouldntMarkProposalReplyAsRead,
  CouldntCreateEmoji,
  CouldntUpdateEmoji,
  CouldntCreatePerson,
  CouldntUpdatePerson,
  ...
  NotPostCreator,
  ProposalNotOnDeliveryPost,
  ProposalAuthorMismatch,
  NotAnActiveRider,
  // Delivery-related errors
  RatingMustBeBetween1And5,
  PostIsNotADeliveryPost,
  DeliveryMustBeCompleted,
  RiderWasNotAssignedToThisDelivery,
  ReasonIsRequiredWhenCancelling,
  InvalidDeliveryPost,
  DeliveryIsNotActive,
  SenderNameIsRequired,
  SenderPhoneIsRequired,
  ReceiverNameIsRequired,
  ...
  PlatformWalletNotInitialized,
  HoldRequiresKindTransfer,
  BothFormsMustBeKindTransfer,
  IdempotencyKeyMustMatchForTransferPair,
  CannotTransferToTheSameWallet,
  MismatchedAmountsForTransferPair,
  AmountMustBePositive,
  CoinSupplyCannotBeNegative,
  // Workflow errors
  InvalidInstallmentsJson,
  InvalidInstallmentsSerialization,
  InvalidRoomIdFormat,
  NoPlatformAdminConfigured,
  WorkflowAlreadyFinalized,
  // Validation errors
  InvalidDateFormatYYYYMMDD,
  BankNotFound,
