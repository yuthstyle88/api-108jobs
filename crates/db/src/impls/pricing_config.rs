...
impl Crud for PricingConfig {
  ...
  async fn create(pool: &mut DbPool<'_>, form: &Self::InsertForm) -> FastJobResult<Self> {
    ...
    insert_into(crate::schema::pricing_config::table)
      .values(form)
  ...
  async fn update(
    ...
    update(crate::schema::pricing_config::table.find(config_id))
      .set(form)
      .get_result::<Self>(conn)
      .await
...
impl PricingConfig {
  pub async fn list_all(pool: &mut DbPool<'_>) -> FastJobResult<Vec<Self>> {
    ...
    crate::schema::pricing_config::table
      .order(crate::schema::pricing_config::is_active.desc())
      .then_order_by(crate::schema::pricing_config::currency_id.asc())
      .load::<Self>(conn)
      .await
  ...
  pub async fn list_by_currency(
    ...
    crate::schema::pricing_config::table
      .filter(crate::schema::pricing_config::currency_id.eq(currency_id))
      .filter(crate::schema::pricing_config::is_active.eq(true))
      .order(crate::schema::pricing_config::name.asc())
      .load::<Self>(conn)
      .await
      .with_fastjob_type(FastJobErrorType::DatabaseError)
  }
  ...
  pub async fn get_active_for_currency(
    ...
    let result = crate::schema::pricing_config::table
      .filter(crate::schema::pricing_config::currency_id.eq(currency_id))
      .filter(crate::schema::pricing_config::is_active.eq(true))
      .first::<Self>(conn)
      .await
