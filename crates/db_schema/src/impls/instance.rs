...
impl Instance {
  ...
  pub async fn delete_all(pool: &mut DbPool<'_>) -> FastJobResult<usize> {
    let conn = &mut get_conn(pool).await?;
  ...
  pub async fn allowlist(pool: &mut DbPool<'_>) -> FastJobResult<Vec<Self>> {
    let conn = &mut get_conn(pool).await?;
    instance::table
  ...
  pub async fn blocklist(pool: &mut DbPool<'_>) -> FastJobResult<Vec<Self>> {
    let conn = &mut get_conn(pool).await?;
    instance::table
  ...
  pub async fn read_federated_with_blocked_and_dead(
    pool: &mut DbPool<'_>,
  ) -> FastJobResult<Vec<(Self, bool, bool)>> {
    let conn = &mut get_conn(pool).await?;
  ...
  pub async fn read_all_with_fed_state(
    pool: &mut DbPool<'_>,
  ) -> FastJobResult<Vec<(Self, Option<FederationQueueState>, bool, bool)>> {
    let conn = &mut get_conn(pool).await?;
    instance::table
