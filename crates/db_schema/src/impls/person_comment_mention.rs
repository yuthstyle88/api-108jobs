use crate::{
  ...
  source::person_comment_mention::{
    PersonCommentMention, PersonCommentMentionInsertForm, PersonCommentMentionUpdateForm,
  },
  traits::Crud,
  utils::{get_conn, DbPool},
};
use app_108jobs_db_schema_file::schema::person_comment_mention;
...
impl Crud for PersonCommentMention {
  ...
  async fn create(pool: &mut DbPool<'_>, form: &Self::InsertForm) -> FastJobResult<Self> {
    ...
    insert_into(person_comment_mention::table)
      ...
      .await
      .with_fastjob_type(FastJobErrorType::CouldntCreatePersonCommentMention)
  }
  ...
  async fn update(
    ...
    diesel::update(person_comment_mention::table.find(person_comment_mention_id))
      ...
      .get_result::<Self>(conn)
      .await
      .with_fastjob_type(FastJobErrorType::CouldntUpdatePersonCommentMention)
  }
}
...
impl PersonCommentMention {
  ...
  ) -> FastJobResult<Vec<PersonCommentMention>> {
    let conn = &mut get_conn(pool).await?;
    diesel::update(
