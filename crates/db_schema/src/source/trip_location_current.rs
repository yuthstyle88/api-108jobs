...
#[cfg_attr(feature = "full", diesel(table_name = trip_location_current))]
#[cfg_attr(feature = "full", diesel(primary_key(post_id)))]
#[cfg_attr(feature = "full", diesel(check_for_backend(diesel::pg::Pg)))]
#[cfg_attr(feature = "ts-rs", derive(ts_rs::TS))]
#[cfg_attr(feature = "ts-rs", ts(optional_fields, export))]
#[serde(rename_all = "camelCase")]
/// Current location of a rider for a trip (shared by delivery and ride taxi).
pub struct TripLocationCurrent {
  pub post_id: PostId,
...
#[cfg_attr(feature = "full", diesel(table_name = trip_location_current))]
pub struct TripLocationCurrentInsertForm {
  pub post_id: PostId,
  pub rider_id: RiderId,
  pub lat: f64,
  pub lng: f64,
...
#[cfg_attr(feature = "full", diesel(table_name = trip_location_current))]
pub struct TripLocationCurrentUpdateForm {
  pub lat: Option<f64>,
  pub lng: Option<f64>,
