# Building app_108jobs Images

app_108jobs's images are meant to be **built** on `linux/amd64`,
...
Namely, we need to link the _app_108jobs_server_ with `pq` and `openssl`
...
app_108jobs's needs, see [the image repository][image-repo].
...
[image-repo]: https://github.com/raskyld/app_108jobs-cross-toolchains
