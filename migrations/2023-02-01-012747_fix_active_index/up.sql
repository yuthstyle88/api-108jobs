...
CREATE INDEX idx_post_aggregates_featured_category_active ON post_aggregates (featured_category DESC, hot_rank (score, newest_comment_time_necro) DESC, newest_comment_time_necro DESC);
