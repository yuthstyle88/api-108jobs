...
ALTER TABLE admin_purge_category RENAME COLUMN published TO published_at;
...
ALTER TABLE category RENAME COLUMN published TO published_at;

ALTER TABLE category RENAME COLUMN updated TO updated_at;

ALTER TABLE category_actions RENAME COLUMN followed TO followed_at;

ALTER TABLE category_actions RENAME COLUMN blocked TO blocked_at;

ALTER TABLE category_actions RENAME COLUMN became_moderator TO became_moderator_at;

ALTER TABLE category_actions RENAME COLUMN received_ban TO received_ban_at;

ALTER TABLE category_actions RENAME COLUMN ban_expires TO ban_expires_at;

ALTER TABLE category_report RENAME COLUMN published TO published_at;

ALTER TABLE category_report RENAME COLUMN updated TO updated_at;
...
ALTER TABLE mod_add_category RENAME COLUMN published TO published_at;

ALTER TABLE mod_ban RENAME COLUMN published TO published_at;

ALTER TABLE mod_ban RENAME COLUMN expires TO expires_at;

ALTER TABLE mod_ban_from_category RENAME COLUMN published TO published_at;

ALTER TABLE mod_ban_from_category RENAME COLUMN expires TO expires_at;

ALTER TABLE mod_change_category_visibility RENAME COLUMN published TO published_at;
...
ALTER TABLE mod_remove_category RENAME COLUMN published TO published_at;

ALTER TABLE mod_remove_post RENAME COLUMN published TO published_at;

ALTER TABLE mod_transfer_category RENAME COLUMN published TO published_at;
